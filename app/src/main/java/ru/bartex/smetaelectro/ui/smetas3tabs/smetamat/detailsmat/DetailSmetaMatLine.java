package ru.bartex.smetaelectro.ui.smetas3tabs.smetamat.detailsmat;
...
public class DetailSmetaMatLine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (costMat == -1.0f){
            Log.d(TAG, "DetailSmetaMatLine costMat =" + costMat);
            //если для mat_id в таблице расценок ничего нет (цена = -1.0f), то вызываем диалог
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            mTextViewSumma.setText(String.format(Locale.getDefault(),"%.2f", (countMat*costMat)));
