...
public class TotalTab {
    ...
    public static void createTable(SQLiteDatabase db){
        ...
        String SQL_CREATE_TAB_TOTAL = "CREATE TABLE " + TABLE_NAME + " ("
                + _ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TOTAL_FILE_ID + " TEXT NOT NULL, "
                + TOTAL_CATEGORY_ID + " TEXT NOT NULL, "
                + TOTAL_TYPE_ID + " TEXT NOT NULL, "
                + TOTAL_WORK_ID + " TEXT NOT NULL, "
                + TOTAL_COST + " REAL NOT NULL DEFAULT 0, "
                + TOTAL_COST_NUMBER + " INTEGER NOT NULL DEFAULT 0, "
                + TOTAL_COST_UNIT + " TEXT NOT NULL, "
