...
public class DialogSaveCostMat extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
       //return super.onCreateDialog(savedInstanceState);
        ...
        //******************вариант, когда Добавить сделано в Категории материала**************
        if (isCat){
            ...
            buttonCostSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    long catId = CategoryMat.getIdFromName(database, nameCat);
            ...
            //******************вариант, когда Добавить сделано в Типе материала**************
        } else if (isType){
            textView4.setVisibility(View.GONE);
            etCost.setVisibility(View.GONE);
            textView.setVisibility(View.GONE);
            ...
            buttonCostSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //++++++++++++++++++   проверяем, есть ли такое имя   +++++++++++++//
                    long typeId = TypeMat.getIdFromName(database, nameType);
                    ...
                    if (nameType.trim().isEmpty()){
                       ...
                       //получаем имя категории по её Id
                        String catMatName = tableControllerSmeta.getNameFromId(cat_id, CategoryMat.TABLE_NAME);
            ...
            //**************вариант, когда Добавить сделано в материале***********
        }else {
            etCost.setText("0");
            ...
            buttonCostSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //++++++++++++++++++   проверяем, есть ли такое имя   +++++++++++++//
                    long matId = Mat.getIdFromName(database, nameMat);
