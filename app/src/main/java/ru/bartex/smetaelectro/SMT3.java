 ...
 */
public class SMT3 extends SmetasTabWorkMat {
    ...
    public static SMT3 NewInstance(
            long file_id, int position, boolean isSelectedType, long type_id){
        Log.d(TAG, "//  SMT3 NewInstance // " );
        SMT3 fragment = new SMT3();
        ...
        Log.d(TAG, "SMT3  NewInstance isSelectedType = " +
    ...
    public void updateAdapter() {
        Log.d(TAG, "//  SMT3 updateAdapter // " );
        Cursor cursor;
        if (isSelectedType){
            Log.d(TAG, "SMT3 updateAdapter isSelectedType = true " );
            //Курсор с именами  всех материалов из таблицы Mat
            cursor = mSmetaOpenHelper.getMatNamesOneType(type_id);
        }else {
            Log.d(TAG, "SMT3 updateAdapter isSelectedType = false " );
            //Курсор с именами  всех материалов из таблицы Mat
        ...
        Log.d(TAG, " SMT3 updateAdapter Всего материалов = "+ cursor.getCount() );
        while (cursor.moveToNext()){
            ...
            Log.d(TAG, " SMT3 updateAdapter mat_name  = " +
        ...
        Log.d(TAG, " SMT3 updateAdapter data.size()  = "+ data.size() );
